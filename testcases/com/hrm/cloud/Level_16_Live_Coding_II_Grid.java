...
public class Level_16_Live_Coding_II_Grid extends BaseTest {
	...
	public void initBrowser(String browserName, String urlPage, String ipAddress, String portName) {

		log.info("Pre-condition - Step 01: Open browser  " + browserName + " with " + urlPage + " ");
		driver = openMultipleBrowsers(browserName, urlPage, ipAddress, portName);
