...
public class Level_16_Live_Coding_III_Browserstack extends BaseTest {
	...
	public void initBrowser(String browserName, String urlPage, String osName, String osVersion) {

		log.info("Pre-condition - Step 01: Open browser  " + browserName + " with " + urlPage + " ");
		driver = openMultipleBrowsersBrowserstack(browserName, urlPage, osName, osVersion);
